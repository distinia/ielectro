import { Sidebar } from './manager.js';
import { App, Alert, Request } from 'C:/xampp/htdocs/ielectro/www/src/components/app/app.js';
class TeamPanel {
    params() {
...
window.addEventListener('DOMContentLoaded', () => {
    new TeamPanel().run().catch(console.error);
});
