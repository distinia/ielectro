...
import { Alert, Request, Mention, Overlay } from "../core/index.js";
...
export class BiographyEditor {
    static async open(page) {
        ...
        overlay.body((body) => {
            body.innerHTML = `
        <form class="bio-form">
          <textarea class="bio-input" maxlength="2000" rows="5" placeholder="Write something about you…">${page.bio || ""}</textarea>
          <div class="bio-actions">
            ...
            body.querySelector(".bio-form")?.addEventListener("submit", async (e) => {
                ...
                try {
                    await Request.patch(Api.user(page.userId), { biography: text });
                    page.bio = text;
                    Mention.renderInto(
